...
namespace LILI_TMS
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<dbTicketManagementContext>();

            services.AddIdentity<ApplicationUser, IdentityRole>()
                .AddEntityFrameworkStores<ApplicationDbContext>()
                .AddDefaultTokenProviders();
            services.AddScoped<IUserWiseBusinessAndPlantService, UserWiseBusinessAndPlantService>();
            //Set form post limit
            ...
            services.AddTransient<IUserWiseBusinessAndPlantService, UserWiseBusinessAndPlantService>();
            //services.AddMvc();
            services.AddMvc()
