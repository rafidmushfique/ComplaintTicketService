...
namespace LILI_TMS.Models
{
    public partial class dbTicketManagementContext : DbContext
    {
        ...
        public virtual DbSet<TblComplainTicket> TblComplainTicket { get; set; }
        ...
        public virtual DbSet<TblComplainTicketImageDetails> TblComplainTicketsImageDetails { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TblComplainTicket>(entity =>
            {
                ...
                entity.HasOne(d => d.SeverityLevelCodeNavigation)
                    .WithMany(p => p.TblComplainTicket)
            ...
            modelBuilder.Entity<TblComplainTicketApproverSmsdetail>(entity =>
            {
                ...
                entity.HasOne(d => d.TicketNoNavigation)
                    .WithMany(p => p.TblComplainTicketsApproverSmsdetails)
                    .HasPrincipalKey(p => p.TicketNo)
                    .HasForeignKey(d => d.TicketNo)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<TblComplainTicketImageDetails>(entity =>
            {
                ...
                entity.HasOne(d => d.TicketNoNavigation)
                    .WithMany(p => p.TblComplainTicketsImageDetails)
                    .HasPrincipalKey(p => p.TicketNo)
                    .HasForeignKey(d => d.TicketNo)
                    .OnDelete(DeleteBehavior.ClientSetNull)
